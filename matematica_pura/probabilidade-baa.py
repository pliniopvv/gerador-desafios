...
questions = {
    ...
    "Suponha que 10% das pessoas tenham uma determinada doença. Um teste para detectar a doença tem uma taxa de falso positivo de 5% e uma taxa de falso negativo de 2%. Se uma pessoa testar positivo para a doença, qual é a probabilidade de ela realmente ter a doença? (em porcentagem)": "66.7",
    "Um experimento consiste em lançar uma moeda justa até obter duas caras consecutivas. Qual é o número esperado de lançamentos?": "6",
}
